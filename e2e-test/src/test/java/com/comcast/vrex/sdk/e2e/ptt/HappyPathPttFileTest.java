...
package com.comcast.vrex.sdk.e2e.ptt;
...
/**
 * Testing sending file directly (not streaming)
 */
public class HappyPathPttFileTest {

    @Test
    public void happyPathPttFileHBOTest() throws Exception {
        happyPathPttFileTest("HBO", "HBO");
    }

    @Test
    public void happyPathPttFileKidsMoviesTest() throws Exception {
        happyPathPttFileTest("show_me_all_kids_movies", "Show me all kids movies");
    }

    public void happyPathPttFileTest(String file, String transcription) throws Exception {
        ...
        AudioInputStream audioInputStream = TestUtils.openFile(file, TriggeredBy.PTT);
